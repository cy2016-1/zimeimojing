...
class Noise():
    ...
    def main(self,name):
        ...
        fs = 16000
        # 读取波形数据
        str_data = name#f.readframes(nframes)#nframes=60000
        print(str_data)
        f.close()
        '''
        ...
        # 将波形数据转换为数组
        x = np.fromstring(name, dtype=np.short)
        # 计算参数
