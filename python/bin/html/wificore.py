...
class Wificore():
    ...
    def restart_network(self):
        os.system('sudo wpa_supplicant -B w -D wext -i '+self.wlan+' -c '+sys_supplicant);
    ...
    def config_wifi(self,set_json):
        ...
        #========================【WiFi 配置重置】==================================
        if self.file_diff(temp_supplicant, sys_supplicant)==False:
            #print('不同')
            os.system('sudo mv '+sys_supplicant+' '+sys_supplicant+'_bak')
            os.system('sudo cp -f '+temp_supplicant+ ' '+sys_supplicant)
