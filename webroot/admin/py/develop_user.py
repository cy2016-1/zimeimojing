...
class develop_user(RequestInit):
    '''开发者账号登录'''

    def __init__(self, handler):
        super().__init__(handler)

        self.RECPATH = r"./runtime/info/developuser"
    ...
    def main(self):
        ...
        # 保存开发者账号
            ...
            webuid = self._POST['webuid']
            username = urllib.parse.unquote(self._POST['username'], encoding='utf-8')
