...
class plugin_update(RequestInit):
    ''' 插件更新 '''
    ...
    def main(self):
        ...
        # 发布插件
        if op=='release':
            version = self._POST['version']     # 版本号
            explain = self._POST['explain']     # 发布说明
            private = self._POST['private']     # 私有插件
            webuid  = self._POST['webuid']      # 发布人帐号ID
            post_data = {
                'version': version,
                'explain': explain,
                'private': private,
